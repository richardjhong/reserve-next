          ...
          <div className="bg-white w-[70%] rounded p-3 shadow text-black">
            ...
            <div className="mt-4">
              <p className="text-lg font-light">
                The classic you love prepared with a perfect twist, all served up in an atmosphere that feels just right. That's the Milestones promise. So, whether you're celebrating a milestone, making the most of Happy Hour or enjoying brunch with friends, you can be sure that every Milestones experience is a simple and perfectly memorable one.
              </p>
            </div>
            {/* DESCRIPTION */}
            {/* IMAGES */}
